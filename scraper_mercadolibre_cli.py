...
if args.paginas:
    ...
    print("No se ingreso cantidad de paginas, por defecto sera 1")
    count_pages = 1
...
logger_info.info(
    "Se guardaran los productos encontrados en el archivo "
    + os.path.join("output", "busqueda_" + product_find + "_ml_" + date_now.split(" ")[0] + ".csv")
)
